...
class Supplier(TransactionBase):
	...
	if TYPE_CHECKING:
		...
		max_price_list: DF.Currency
		min_price_list: DF.Currency
		...
		supplier_type: DF.Literal["Company", "Individual", "Proprietorship", "Partnership", "Wedding Organizer", "Vendor"]
		tax_category: DF.Link | None
		tax_id: DF.Data | None
		tax_withholding_category: DF.Link | None
		total_user_review: DF.Int
		warn_pos: DF.Check
		warn_rfqs: DF.Check
